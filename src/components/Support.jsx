    ...
    <div name="support" className="w-full mt-24">
      ...
      <div className="max-w-[1240px] mx-auto text-white relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black">
          <div className="bg-white rounded-xl shadow-2xl hover:shadow-none">
            <div className="p-8">
          ...
          <div className="bg-white rounded-xl shadow-2xl hover:shadow-none">
            <div className="p-8">
              <ChatBubbleLeftEllipsisIcon className="w-16 p-4 bg-indigo-600 text-white rounded-lg mt-[-4rem]" />
          ...
          <div className="bg-white rounded-xl shadow-2xl hover:shadow-none">
            <div className="p-8">
              <CurrencyDollarIcon className="w-16 p-4 bg-indigo-600 text-white rounded-lg mt-[-4rem]" />
              <h3 className="font-bold text-2xl my-6">Pricing Inquiries</h3>
              <p className="text-gray-600 text-xl">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Excepturi provident iure placeat blanditiis ea sint earum hic
                iste quibusdam exercitationem.
